namespace WindowsForms房屋出租UI
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button2.Text = "客房基本信息查询（客房编号）";
            ...
            this.button3.Text = "客人租房信息查询（身份证号）";
            ...
            this.button5.Text = "客房基本信息查询（类别、租金）";
            ...
            this.button6.Text = "客人租房信息查询（姓名、时间）";
